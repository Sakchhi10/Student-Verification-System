...
message = tk.Label(window, text="PES UNIVERSITY" ,bg="white"  ,fg="black"  ,width=20  ,height=2,font=('Times New Roman', 25, 'bold'))
message.place(x=1150, y=760)

message = tk.Label(window, text="PESU-ESA STUDENT VERIFICATION SYSTEM" ,bg="pink"  ,fg="black"  ,width=40  ,height=1,font=('Times New Roman', 35, 'bold underline'))
...
def read_barcodes(frame):
    ...
    for barcode in barcodes:
        ...
        cv2.putText(frame, barcode_info, (x + 6, y - 6), font, 2.0, (255, 0, 0), 2)
        # 3
        with open("StudentDetails/barcode_result.csv", mode='w') as file:
...
trainImg.place(x=475 - x_cord, y=425 - y_cord)
...
barWindow = tk.Button(window, text="BARCODE",command=main, fg="white", bg="blue", width=15,
                      height=2, activebackground="pink", font=('Times New Roman',15,'bold'))
barWindow.place(x=820 - x_cord, y=425 - y_cord)
